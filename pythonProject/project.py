...
cool_car_up= pygame.transform.scale(cool_car_up, (70, 100))
blue_car_up=pygame.image.load("blue_car_up.png")
blue_car_up = pygame.transform.scale(blue_car_up, (70, 100))
red_car_up=pygame.image.load("red_car_up.png")
red_car_up = pygame.transform.scale(red_car_up, (70, 100))
green_car_up=pygame.image.load("green_car_up.png")
green_car_up = pygame.transform.scale(green_car_up, (70, 100))
main_car=pygame.image.load("car.png")
main_car = pygame.transform.scale(main_car, (70, 100))
...
play_label = label.render('Играть!', False, (0, 0, 0))
play_label_rect = play_label.get_rect(topleft=(370,250))
restart_label = label1.render('Играть заново!', False, (255, 255, 255))
restart_label_rect = restart_label.get_rect(topleft=(300, 450))
skin_label = label1.render('Скинчики', False, (0, 0, 0))
skin_label_rect = skin_label.get_rect(topleft=(360, 350))
